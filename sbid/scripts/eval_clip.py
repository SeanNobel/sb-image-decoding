...
from sbid.datasets.things_meg import ThingsMEGCLIPDataset
from sbid.models.brain_encoder import BrainEncoder
from sbid.models.vision_encoders import ViT, ViViT, ViViTReduceTime, Unet3DEncoder
from sbid.utils.layout import ch_locations_2d, DynamicChanLoc2d
from sbid.utils.train_utils import sequential_apply
from sbid.utils.eval_utils import (
    VisionSaver,
    EmbeddingSaver,
    update_with_eval,
    get_run_dir,
