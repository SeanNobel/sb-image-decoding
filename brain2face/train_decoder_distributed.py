"""Modified from:
https://github.com/SeanNobel/DALLE2-pytorch/blob/main/train_decoder.py
"""
# fmt: off
import sys
...
def create_dataloaders(
    ...
    **kwargs
    ...
    #     dataset=train_split, batch_size=batch_size, shuffle=True, num_workers=num_workers, pin_memory=True
    # )
    # train_sampling_dataloader = torch.utils.data.DataLoader(
    #     dataset=train_split, batch_size=n_sample_images, shuffle=True, num_workers=num_workers, pin_memory=True
    # )
    # val_dataloader = torch.utils.data.DataLoader(
    #     dataset=val_split, batch_size=batch_size, shuffle=False, num_workers=num_workers, pin_memory=True
    # )
    # test_dataloader = torch.utils.data.DataLoader(
    #     dataset=test_split, batch_size=batch_size, shuffle=False, num_workers=num_workers, pin_memory=True
    # )
    # test_sampling_dataloader = torch.utils.data.DataLoader(
    #     dataset=test_split, batch_size=n_sample_images, shuffle=False, num_workers=num_workers, pin_memory=True
    # )
...
@click.command()
@click.option("--config_file", default="configs/decoder.json", help="Path to config file")
